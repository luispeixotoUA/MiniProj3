    ...
    <b-container fluid>
      ...
      <b-row>
        ...
        <b-col cols="4">
          ...
          <b-card-group deck class="mt-3">
            <AdminOptionBox routeName="listSponsors" iconName="user-check" title="Patrocinadores"/>
            <AdminOptionBox routeName="listSpecialists" iconName="user-md" title="Especialistas"/>
          </b-card-group>
        </b-col>
        <b-col cols="4"></b-col>
      </b-row>
